    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#070a13] text-slate-800 dark:text-slate-200 flex flex-col justify-between transition-colors duration-200">
      ...
      <main className="max-w-3xl mx-auto w-full px-6 py-12 flex-1">
        ...
        <div className="space-y-6 text-slate-650 dark:text-slate-350 leading-relaxed text-justify text-sm">
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">1. Log Files</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">2. Cookies and Web Beacons</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">3. Amazon Affiliate Cookies (Third-Party Partners)</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">4. DoubleClick DART Cookie</h2>
          <p>
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mt-8">5. Consent</h2>
          <p>
